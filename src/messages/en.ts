const en = {
  ...
  settings: {
    ...
    noNotifDesc: 'You\'ll see your notifications here',
    ...
    autoApplyCoupon: 'Auto-Apply Coupons',
    autoApplyCouponDesc: 'Automatically apply best available coupon at checkout',
    // More notification prefs
    notifyWishlist: 'Wishlist Alerts',
    notifyWishlistDesc: 'Get notified when wishlist items go on sale',
    notifyStock: 'Back in Stock',
    ...
    privacyDesc: 'Manage your account security and session settings',
    loginAlerts: 'Login Alerts',
    loginAlertsDesc: 'Get notified when someone logs into your account',
    activeSessions: 'Active Sessions',
    activeSessionsDesc: 'You are currently signed in on this device. You can sign out of all other sessions for security.',
