...
const DEMO_REVIEWS: HomeReview[] = [
  { id: 'd1', rating: 5, comment: 'Best label printer I have used. Crystal clear prints and the rolls last a long time. Setup was extremely easy too.', created_at: '2025-03-10T10:00:00Z', reviewer_name: 'Ahmed Al-Rashidi', avatar_url: null, product_name: 'Zebra ZD421', product_brand: 'Zebra' },
  ...
  { id: 'd5', rating: 5, comment: 'PAX smart terminal exceeded our expectations. Contactless payments work perfectly and the screen is crisp and bright.', created_at: '2025-02-28T16:00:00Z', reviewer_name: 'Karwan Saleh', avatar_url: null, product_name: 'PAX A920 Pro', product_brand: 'PAX Technology' },
